      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="card p-6">
          ...
          <ul className="mt-2 space-y-1 text-sm text-zinc-700">
            <li>WhatsApp: <a className="hover:underline" href="https://wa.me/5546991061375" target="_blank" rel="noreferrer">(46) 99106-1375</a></li>
            <li>E-mail: <a className="hover:underline" href="mailto:saantosrafael1@gmail.com">saantosrafael1@gmail.com</a></li>
            <li>Instagram: <a className="hover:underline" href="https://www.instagram.com/rafaaell.santos/" target="_blank" rel="noreferrer">@rafaaell.santos</a></li>
          </ul>
        </div>
      </div>
    </Section>
